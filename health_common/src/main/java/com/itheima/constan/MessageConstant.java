...
public class MessageConstant {
    ...
    public static final String DELETE_CHECKITEM_FAIL_HAVE_CHECKGROUP = "该检查项已经绑定到其他检查组,无法删除";
    ...
    public static final String VALIDATECODE_OUTDATE = "验证码已过期";
    ...
    public static final String SELECTED_DATE_CANNOT_EMPTY = "预约日期不能为空";
    ...
    public static final String DELETE_PERMISSION_FAIL_WITH_ROLE = "该权限已经被使用,无法删除,请联系管理员";
    //菜单管理
    public static final String GET_MENU_LIST_FAIL = "查询菜单列表数据失败";
    public static final String GET_MENUL_IST_SUCCESS = "查询菜单列表数据成功";
    public static final String ADD_MENU_SUCCESS = "新增菜单数据成功";
    public static final String ADD_MENU_FAIL = "新增菜单数据失败";
    ...
    public static final String DELETE_MENU_FAIL_WITH_ROLE = "该菜单已经被使用,无法删除,请联系管理员";
    //角色管理
    ...
    public static final String ADD_ROLEU_FAIL = "新增角色数据失败";
    public static final String QUERY_ROLE_SUCCESS = "查询角色数据成功";
    public static final String QUERY_ROLE_FAIL = "查询角色数据失败";
    public static final String EDIT_ROLE_SUCCESS = "修改角色数据成功";
    public static final String EDIT_ROLE_FAIL = "修改角色数据失败";
    public static final String DELETE_ROLE_SUCCESS = "删除角色数据成功";
    public static final String DELETE_ROLE_FAIL = "删除角色数据失败";
    public static final String DELETE_ROLE_FAIL_WITH_OTHERS = "该角色已经被使用,无法删除,请联系管理员";
    //菜单和权限
    public static final String GET_MENU_LIST_AND_PERMISSION_LIST_SUCCESS = "查询菜单和权限列表数据成功";
    public static final String GET_MENU_LIST_AND_PERMISSION_LIST_FAIL = "查询菜单和权限列表数据失败";
    //用户管理
    public static final String GET_USER_LIST_FAIL = "查询用户列表数据失败";
    public static final String GET_USER_LIST_SUCCESS = "查询用户列表数据成功";
    public static final String ADD_USER_SUCCESS = "新增用户数据成功";
    public static final String ADD_USER_FAIL = "新增用户数据失败";
    ...
    public static final String DELETE_USERE_SUCCESS = "删除用户数据成功";
    public static final String DELETE_USER_FAIL = "删除用户数据失败";
    public static final String DELETE_USER_FAIL_WITH_OTHERS = "该用户已经被使用,无法删除,请联系管理员";
    //用户修改密码
    public static final String MODIFY_PASSWORD_SUCCESS = "修改密码成功,请妥善保管修改后的密码";
    public static final String INPUT_PASSWORD_ERROR = "查询不到该手机号码,请检查输入手机号码是否正确";
